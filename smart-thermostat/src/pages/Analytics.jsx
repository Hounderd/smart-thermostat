...
import { ArrowDown, ArrowUp, Timer, Activity, Home, CloudSun, TrendingUp, DollarSign, Settings, Save, RotateCcw } from 'lucide-react';
...
function Analytics() {
  ...
  return (
    <div className="p-4 md:p-8 max-w-6xl mx-auto flex flex-col gap-8 pb-32">
      ...
      {/* --- MAIN CHART: THERMAL PERFORMANCE --- */}
